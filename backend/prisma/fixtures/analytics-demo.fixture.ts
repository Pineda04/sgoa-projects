...
async function main() {
  ...
  const demoDepartment1 = await prisma.department.upsert({
    ...
    create: {
      id: ids.department1,
      name: 'Demo Departamento Principal',
  ...
  const demoDepartment2 = await prisma.department.upsert({
    ...
    create: {
      id: ids.department2,
      name: 'Demo Departamento Secundario',
      facultyId: faculty.id,
    },
  });
  const demoCenterDepartment1 = await prisma.centerDepartment.upsert({
    ...
    create: {
      id: ids.centerDepartment1,
      centerId: demoCenter.id,
      departmentId: demoDepartment1.id,
    },
  });
  const demoCenterDepartment2 = await prisma.centerDepartment.upsert({
    ...
    create: {
      id: ids.centerDepartment2,
      centerId: demoCenter.id,
      departmentId: demoDepartment2.id,
    },
  });
  ...
  for (const relation of [
    {
      id: ids.roomDepartment1,
      classroomId: ids.room1,
      departmentId: demoDepartment1.id,
    },
    {
      id: ids.roomDepartment2,
      classroomId: ids.room2,
      departmentId: demoDepartment1.id,
    },
    {
      id: ids.roomDepartment3,
      classroomId: ids.room3,
      departmentId: demoDepartment2.id,
    },
    {
      id: ids.roomDepartment3Primary,
      classroomId: ids.room3,
      departmentId: demoDepartment1.id,
    },
    {
      id: ids.roomDepartment4,
      classroomId: ids.room4,
      departmentId: demoDepartment1.id,
    },
    {
      id: ids.roomDepartmentVirtual,
      classroomId: ids.roomVirtual,
      departmentId: demoDepartment1.id,
    },
  ]) {
  ...
  await prisma.digitalBlackboard.upsert({
    ...
    update: {
      description: 'Demo Pizarra B',
      brandId: brand.id,
      monitorTypeId: monitorType.id,
      monitorSizeId: monitorSize.id,
      conditionId: demoCondition.id,
      classroomId: ids.room3,
    },
    create: {
      id: ids.blackboard2,
  ...
  for (const pc of [
    {
      id: ids.pc1,
      inventoryNumber: 'DEMO-PC-001',
      classroomId: ids.room2,
      conditionId: condition.id,
    },
    {
      id: ids.pc2,
      inventoryNumber: 'DEMO-PC-002',
      classroomId: ids.room3,
      conditionId: demoCondition.id,
    },
  ]) {
  ...
  const users = [
    {
      id: ids.user1,
      name: 'Demo Docente Uno',
      email: 'demo-teacher-1@example.invalid',
      code: 'DEMO-T1',
    },
    {
      id: ids.user2,
      name: 'Demo Docente Dos',
      email: 'demo-teacher-2@example.invalid',
      code: 'DEMO-T2',
    },
    {
      id: ids.user3,
      name: 'Demo Docente Tres',
      email: 'demo-teacher-3@example.invalid',
      code: 'DEMO-T3',
    },
  ];
  ...
  for (const teacher of [
    ...
    },
    {
      ...
      contractTypeId: demoContract.id,
  ...
  for (const appointment of [
    {
      ...
      positionId: nonePosition.id,
      centerDepartmentId: demoCenterDepartment1.id,
    },
    {
      id: ids.appointment2,
    ...
    {
      id: ids.appointment3,
      teacherId: ids.teacher3,
      positionId: headPosition.id,
      centerDepartmentId: demoCenterDepartment2.id,
    },
  ]) {
  ...
  for (const session of [
    ...
    await prisma.teachingSession.upsert({
      ...
      update: {
        ...session,
        consultHour: new Date('2093-01-10T14:00:00.000Z'),
        tutoringHour: new Date('2093-01-10T15:00:00.000Z'),
      },
      create: {
        ...session,
        consultHour: new Date('2093-01-10T14:00:00.000Z'),
  ...
  const sectionRows = [
    {
      ...
      classroomId: ids.room1,
      teachingSessionId: ids.session1,
      studentCount: 45,
      modalityId: presentialModality.id,
      groupCode: 'DEMO-A',
      days: 'Lu',
      section: '08:00 - 10:00',
    },
    ...
    },
    {
      ...
      classroomId: ids.room2,
      teachingSessionId: ids.session2,
      studentCount: 0,
      modalityId: presentialModality.id,
      groupCode: 'DEMO-B',
      days: 'Ma',
    ...
    },
    {
      ...
      courseId: ids.course1,
      classroomId: ids.room3,
      teachingSessionId: ids.session3,
      studentCount: 12,
      modalityId: presentialModality.id,
      groupCode: 'DEMO-B2',
      days: 'Vi',
    ...
    },
    {
      ...
      courseId: ids.course3,
      classroomId: ids.room1,
      teachingSessionId: ids.session4,
      studentCount: 20,
      modalityId: presentialModality.id,
      groupCode: 'DEMO-P2A',
      days: 'Lu',
    ...
    },
    {
      ...
      courseId: ids.course4,
      classroomId: ids.room2,
      teachingSessionId: ids.session5,
      studentCount: 55,
      modalityId: presentialModality.id,
      groupCode: 'DEMO-P2B',
      days: 'Ma',
  ...
  for (const statistic of [
    {
      id: ids.statistic1,
      courseClassroomId: ids.section1,
      APB: 20,
      RPB: 10,
      NSP: 5,
      ABD: 10,
    ...
    {
      id: ids.statistic2,
      courseClassroomId: ids.section3,
      APB: 0,
      RPB: 0,
      NSP: 0,
      ABD: 0,
    ...
    {
      id: ids.statistic3,
      courseClassroomId: ids.section5,
      APB: 30,
      RPB: 20,
      NSP: 5,
      ABD: 5,
    ...
    {
      id: ids.statistic4,
      courseClassroomId: ids.section6,
      APB: 8,
      RPB: 2,
      NSP: 1,
      ABD: 1,
  ...
  for (let index = 0; index < activityTypeNames.length; index += 1) {
    activityTypes.push(
      await prisma.activityType.upsert({
        ...
        update: {
          name: activityTypeNames[index],
          description: 'Tipo de actividad demo',
        },
        create: {
          id: activityTypeIds[index],
          name: activityTypeNames[index],
          description: 'Tipo de actividad demo',
        },
      }),
  ...
  for (const [index, activity] of (
    [
      {
        id: ids.activity1,
        name: 'Demo actividad docencia',
        reportId: ids.report1,
        registered: true,
        progress: 'Completada',
      },
      {
        id: ids.activity2,
        name: 'Demo actividad investigacion',
        reportId: ids.report1,
        registered: false,
        progress: 'En proceso',
      },
      {
        id: ids.activity3,
        name: 'Demo actividad vinculacion',
        reportId: ids.report1,
        registered: null,
        progress: 'Iniciada',
      },
      {
        id: ids.activity4,
        name: 'Demo actividad innovacion',
        reportId: ids.report2,
        registered: true,
        progress: 'Completada',
      },
      {
        id: ids.activity5,
        name: 'Demo actividad curriculum',
        reportId: ids.report2,
        registered: false,
        progress: 'En proceso',
      },
      ...
      {
        id: ids.activity8,
        name: 'Demo actividad periodo dos',
        reportId: ids.report4,
        registered: true,
        progress: 'Completada',
      },
    ] as const
    ...
    await prisma.complementaryActivity.upsert({
      ...
      update: {
        name: activity.name,
        assignmentReportId: activity.reportId,
        activityTypeId: activityTypes[index % activityTypes.length].id,
        isRegistered: activity.registered,
        progressLevel: activity.progress,
        fileNumber: activity.registered ? `DEMO-${index + 1}` : null,
      },
      create: {
        id: activity.id,
        name: activity.name,
  ...
  for (const media of [
    {
      ...
      description: 'Evidencia demo de docencia',
    },
    {
      id: ids.media2,
      activityId: ids.activity2,
      description: 'Evidencia demo de investigacion',
    },
    {
      id: ids.media3,
      activityId: ids.activity3,
      description: 'Evidencia demo de vinculacion',
    },
  ]) {
  ...
  for (const check of [
    {
      ...
      buildingId: demoBuilding1.id,
      checkDate: '2093-01-10T06:00:00.000Z',
      checkTime: '08:00',
      isPresent: true,
      status: DigitalBlackboardUseStatus.USED,
    },
    {
      id: ids.check2,
      courseClassroomId: ids.section3,
      monitorId: monitor1.id,
      buildingId: demoBuilding1.id,
      checkDate: '2093-01-11T06:00:00.000Z',
      checkTime: '10:00',
      isPresent: false,
      status: DigitalBlackboardUseStatus.NOT_USED,
    },
    {
      id: ids.check3,
      courseClassroomId: ids.section6,
      ...
      buildingId: demoBuilding2.id,
      checkDate: '2093-01-12T06:00:00.000Z',
      checkTime: '08:00',
      isPresent: true,
      status: DigitalBlackboardUseStatus.UNKNOWN,
    },
    {
      id: ids.check4,
      courseClassroomId: ids.section4,
      monitorId: monitor1.id,
      buildingId: demoBuilding1.id,
      checkDate: '2093-01-13T06:00:00.000Z',
      checkTime: '09:00',
      isPresent: false,
      status: null,
    },
    {
      id: ids.check5,
      courseClassroomId: ids.section7,
      monitorId: monitor1.id,
      buildingId: demoBuilding1.id,
      checkDate: '2093-05-10T06:00:00.000Z',
      checkTime: '08:00',
      isPresent: true,
      status: DigitalBlackboardUseStatus.USED,
    },
    {
      ...
      monitorId: monitor1.id,
      buildingId: demoBuilding1.id,
      checkDate: '2093-01-14T06:00:00.000Z',
      checkTime: '14:00',
      isPresent: true,
      status: DigitalBlackboardUseStatus.UNKNOWN,
    },
  ...
  const manifest = {
    ...
    counts: {
      courses: await prisma.course.count({
        where: {
          id: {
            in: Object.values(ids).filter((id) => id.includes('00000000001')),
          },
        },
      }),
      sections: await prisma.courseClassroom.count({
        where: { id: { in: sectionRows.map(({ id }) => id) } },
      }),
      activities: await prisma.complementaryActivity.count({
        where: {
          id: {
            in: [
              ids.activity1,
      ...
      checks: await prisma.scheduleComplianceCheck.count({
        where: {
          id: {
            in: [
              ids.check1,
