...
import { Error, SearchAsyncSelect } from '@components';
...
import { useGetCoursesCenterDepartmentBySearchTerm } from '../hooks';
import { TCourseBasicInfo } from '../types';
import { TClassroom, useGetClassroomsBySearchTerm } from '@features/centers';
		...
		<>
			...
			>
				...
				<div className="md:col-span-2 flex justify-end gap-2 mt-2">
					<Button
						type="submit"
						className="w-[100px] justify-center bg-[#5BC85C] text-white p-2 hover:bg-green-300 transition duration-300 cursor-pointer"
					...
					<Button
						type="button"
						className="w-[100px] justify-center bg-[#fc4c3f] text-white p-2 hover:bg-red-300 transition duration-300 cursor-pointer"
						onClick={onCancel}
						variant="unstyled"
					>
						Cancelar
