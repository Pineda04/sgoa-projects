...
import {
	...
	useGetAllUndergrads,
} from '@features/shared/academic/hooks';
import { TAcademicCommonProps } from '@features/teachers';
import { Error, Loading } from '@components';
import { TCreateUser, initialValuesUser, userCreateSchema } from '../schemas';
import { useAuth } from '@providers/auth';
import { EUserRole } from '@types';
import { AccessRoles, SelectCenterDepartments } from '../components';
...
export const CreateUser = () => {
	...
	const {
		// values: { name, code, email, contractTypeId },
		values,
		setValues,
		handleChange,
		handleBlur,
	...
	return (
		<>
			...
			<div className="p-10 rounded shadow-md w-full max-w-4xl h-fit bg-white m-auto">
				<span
					className="text-2xl font-bold bg-red-"
					// htmlFor="Titulo"
				>
					Nuevo Usuario
				</span>
