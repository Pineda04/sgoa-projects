...
import { DataTable, IDataTableColumn, ModalBase, Pagination } from '@components';
import { Button } from '@components/ui/button';
import { TOutputTeacherPosition } from '@features/teachers';
...
export const UserTable = ({
	...
	const columns: IDataTableColumn<TOutputTeacherPosition>[] = [
		...
		{ key: 'categoryName', header: 'Categoría', mobileLabel: 'Categoría', hiddenOnMobile: true },
		{ key: 'contractTypeName', header: 'Contratación', mobileLabel: 'Contrato', hiddenOnMobile: true },
		{
			key: 'actions',
			header: 'Acciones',
