...
export const EditCenterModal = ({ isOpen, onClose, center }: EditCenterModalProps) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        updateCenter({ id: center.id, data: { name } }, {
            onSuccess: () => {
                genericAlert(
    ...
    return (
        <ModalBase isOpen={isOpen} onClose={onClose}>
            <div className="p-2">
                <h1 className="text-xl font-bold text-slate-800 mb-1">Editar Centro Operativo</h1>
                <p className="text-xs text-gray-500 mb-5">Modifica el nombre del centro seleccionado.</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t border-gray-100 mt-4">
                        ...
                        >
                            ...
                            <span>{isPending ? 'Guardando...' : 'Actualizar Centro'}</span>
                        </Button>
                    </div>
                </form>
            </div>
