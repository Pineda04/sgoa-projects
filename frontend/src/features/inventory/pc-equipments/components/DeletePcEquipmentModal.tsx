...
interface DeletePcEquipmentModalProps {
	isOpen: boolean;
	onClose: () => void;
	onConfirm: () => void;
...
export const DeletePcEquipmentModal = ({
	isOpen,
	onClose,
	onConfirm,
	inventoryNumber,
	isPending = false,
}: DeletePcEquipmentModalProps) => {
	return (
		<ModalBase isOpen={isOpen} onClose={onClose}>
			<div className="p-4">
				<p className="text-center text-gray-600 text-lg font-normal leading-relaxed">
					¿Está seguro que desea eliminar el equipo con número de
					inventario{' '}
