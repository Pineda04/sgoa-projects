...
interface DeleteAudioEquipmentModalProps {
    isOpen: boolean;
    onClose: () => void;
    onConfirm: () => void;
...
export const DeleteAudioEquipmentModal = ({
    isOpen,
    onClose,
    onConfirm,
    description,
    isPending = false,
}: DeleteAudioEquipmentModalProps) => {
    return (
        <ModalBase isOpen={isOpen} onClose={onClose}>
            <div className="p-4">
                <p className="text-center text-gray-600 text-lg font-normal leading-relaxed">
                    ¿Está seguro que desea eliminar el equipo de audio{' '}
