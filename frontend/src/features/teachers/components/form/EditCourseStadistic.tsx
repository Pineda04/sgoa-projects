...
import { useUpdateCourseStadistic } from '@features/teachers/hooks';
import { courseStadisticSchema } from '@features/teachers/schemas';
import {
	TCourseClassroom,
	TCourseStadistic,
...
export const EditCourseStadistic = ({
	reportId,
	infoCourseClassroom,
	mode,
}: {
	...
	//const toggleInputsActive = () => setIsInputsActive(prev => !prev);
	...
	const onSubmitting = async (values: TCourseStadisticOmit) => {
		...
		// console.log('Datos!!');
		// console.log(
		// 	'ID de courseStadistic:',
		// 	infoCourseClassroom.courseStadistic.id
		// );
