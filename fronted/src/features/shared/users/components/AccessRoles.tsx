// Este componente es para seleccionar el departamento, rol de acceso y cargo académico...
// ...la decisión de separarlo es por las consultas, habría que hacer 3 extra si se deja todo en CreateUser...
// ...y cuando sea rool de coordinador esas 3 serían extra.
...
import { useGetAllPositions } from '@features/shared/academic';
	...
	return (
		<>
			...
			<div className="mt-6">
				...
				{/* 		EUserRole.DIRECCION, */}
				{/* 		EUserRole.RRHH, */}
				{/* 	].map((r, index) => ({ id: index.toString(), name: r })) */}
				{/* </select> */}
				<Select
					name="roles"
