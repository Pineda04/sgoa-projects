...
import { Loading, ModalBase } from '../../../components';
...
import {
	...
	useGetAllCoursesCoordinatorByPeriod,
} from '../hooks';
import { UploadPlanification } from '../components';
import { useModal } from '@hooks';
import { useUser } from '@providers/user';
import { useGetAcademicPeriodNextToCreate } from '@features/shared/academic';
import { CourseClassroomsTable } from '@features/shared/planifications';
...
export const CreatePlanification = () => {
	...
	const handleSend = async () => {
		...
		await mutateAsync(
			...
			},
			{
				onSuccess: () => {
					navigate(
						`/coordinadores/dashboard-coordinador?centerDepartmentId=${centerDepartmentId}`
					);
				},
	...
	return (
		<>
			...
			{/* <pre> */}
			{/*   {coursesInfo.data && JSON.stringify(coursesInfo.data, null, 2)} */}
			{/* </pre> */}
			{coursesInfo.data &&
