...
import { TTeachingSession } from '@features/teachers/types';
import { toHondurasTimeInput } from '@utils';
import { EditCourseStadistic } from '../form/EditCourseStadistic';
import { useUpdateTeachingSession } from '@features/teachers/hooks';
import {
	PencilIcon,
	CheckCircleIcon,
	XCircleIcon,
...
export const TeachingSession = ({
	...
	// const toggleInputsActive = async () => {
	// 	if (isInputsActive && data) {
	// 		setIsSaving(true);

	// 		const consultIso = formatTimeToISO(horaConsulta, data.consultHour);
	// 		const tutoringIso = formatTimeToISO(
	// 			horaTutorias,
	// 			data.tutoringHour
	// 		);
	...
	return (
		<>
			{/* <h2 className="text-center mt-20 mb-5 text-lg font-bold">Docencia</h2> */}
